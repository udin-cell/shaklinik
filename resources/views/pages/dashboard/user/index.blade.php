        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Pasien Master</h4>
                    <span class="ml-1">Pasien Terdaftar Sha-Clinic</span>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Table-Master Pasien</h4>
                    </div>
                    <div class="card-body">
    ...
    // AJAX DataTable
                var datatable = $('#crudTable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'kode_pasien', name: 'kode_pasien', width: '10%' },
                        { data: 'name', name: 'name',  },
                        { data: 'umur', name: 'umur', width: '10%' },
                        { data: 'tgl_lahir', name: 'tgl_lahir', width: '10%' },
