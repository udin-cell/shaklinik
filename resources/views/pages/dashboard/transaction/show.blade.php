                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="invoice-title">
                                    <h4 class="float-end font-size-15">Invoice {{$transaction->kode_inv}} <span
                                            class="badge bg-success font-size-12 ms-2">{{$transaction->status}}</span>
                                    </h4>
                                    <div class="mb-4">
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <p><i class="uil uil-phone me-1"></i> {{$transaction->phone}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="text-muted">
                                            ...
                                            <h5 class="font-size-15 mb-2">{{$transaction->user->name}}</h5>
                                            <p class="mb-1">{{$transaction->address}}</p>
                                            <p class="mb-1">{{$transaction->email}}</p>
                                        ...
                                        <table class="table align-middle table-nowrap table-centered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-muted">Rp.{{number_format($item->product->price)}}
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-0 text-end">
                                                        <h4 class="m-0 fw-semibold">
                                                            Rp.{{number_format($transaction->total_price)}}</h4>
                                                    </td>
                                                </tr>
                                                <!-- end tr -->
                                            </tbody><!-- end tbody -->
