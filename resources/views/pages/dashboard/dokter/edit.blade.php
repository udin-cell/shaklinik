        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form">
                            <form class="form" action="{{route('dashboard.dokter.update' , $item->id)}}" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username"
                                                    value="{{$item->nama_dokter}}" name="nama_dokter"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control " id="val-suggestions" name="alamat"
                                                    rows="5"
                                                    placeholder="Isi Alamat Dokter">{{$item->alamat}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="price" name="no_tlpn"
                                                    value="{{$item->no_tlpn}}" placeholder="No Telepone">
                                            </div>
                                        </div>
