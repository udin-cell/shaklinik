        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form">
                            <form class="form" action="{{route('dashboard.product.update', $item->id)}}" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name"
                                                    value="{{$item->name}}" placeholder="Masukan Nama Produk">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control " id="val-suggestions" name="description"
                                                    rows="5"
                                                    placeholder="Isi Deskripsi Produk">{{$item->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="price" name="price"
                                                    value="{{$item->price}}" placeholder="Rp.21.60">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="stock" name="stock"
                                                    value="{{$item->stock}}" placeholder="5">
                                            </div>
                                        </div>
