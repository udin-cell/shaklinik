    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="umur" class="block mt-1 w-full" type="text" name="umur" :value="old('umur')"
                    required />
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                <x-jet-label for="no_tlp" value="{{ __('No Telepon') }}" />
                <x-jet-input id="no_tlp" class="block mt-1 w-full" type="text" name="no_tlp"
                    :value="old('no_tlp') ? old('no_tlp') : '62'" required />
            </div>
